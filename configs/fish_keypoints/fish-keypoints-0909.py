...
dataset_type = 'Fish0908Dataset' # 数据集类名
data_mode = 'topdown'
# data_root = 'data/zebra/'
data_root = 'data/Fish-Tracker-0908/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='annotations/Fish-Tracker-0908-Train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='annotations/Fish-Tracker-0908-Test.json',
